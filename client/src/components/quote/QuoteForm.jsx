        ...
        <form className="quote-form" onSubmit={handleSubmit} noValidate>
          ...
          <div className="quote-form__row">
            <div className="quote-form__field">
              ...
              <input className="quote-form__input" id="firstName" name="firstName" type="text" placeholder="John" value={form.firstName} onChange={handleChange} required />
            </div>
            <div className="quote-form__field">
              <label className="quote-form__label" htmlFor="lastName">Last Name</label>
              <input className="quote-form__input" id="lastName" name="lastName" type="text" placeholder="Smith" value={form.lastName} onChange={handleChange} required />
            </div>
          </div>
          ...
          <div className="quote-form__row">
            <div className="quote-form__field">
              ...
              <input className="quote-form__input" id="phone" name="phone" type="tel" placeholder="(704) 555-0123" value={form.phone} onChange={handleChange} required />
            </div>
            <div className="quote-form__field">
              <label className="quote-form__label" htmlFor="email">Email Address</label>
              <input className="quote-form__input" id="email" name="email" type="email" placeholder="john@email.com" value={form.email} onChange={handleChange} required />
            </div>
          </div>
          ...
          <div className="quote-form__field quote-form__field--full">
            ...
            <input className="quote-form__input" id="street" name="street" type="text" placeholder="412 Maple Drive" value={form.street} onChange={handleChange} required />
          </div>

          <div className="quote-form__row quote-form__row--thirds">
            <div className="quote-form__field">
              <label className="quote-form__label" htmlFor="city">City</label>
              <input className="quote-form__input" id="city" name="city" type="text" placeholder="Charlotte" value={form.city} onChange={handleChange} required />
            </div>
            <div className="quote-form__field">
              <label className="quote-form__label" htmlFor="state">State</label>
              <input className="quote-form__input" id="state" name="state" type="text" placeholder="NC" maxLength={2} value={form.state} onChange={handleChange} required />
            </div>
            <div className="quote-form__field">
              <label className="quote-form__label" htmlFor="zip">ZIP Code</label>
              <input className="quote-form__input" id="zip" name="zip" type="text" placeholder="28205" maxLength={5} value={form.zip} onChange={handleChange} required />
            </div>
          </div>
          ...
          <div className="quote-form__field quote-form__field--full">
            ...
            <div className="quote-form__select-wrapper">
              <select className="quote-form__select" id="lastWash" name="lastWash" value={form.lastWash} onChange={handleChange} required>
